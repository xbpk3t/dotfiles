...
let
  cfg = config.modules.devops.direnv;
in
{
  # host:
  #   modules.devops.direnv.enable = true;

  options.modules.devops.direnv = with lib; {
    enable = mkEnableOption "direnv / nix-direnv + devbox + devenv (shell env management)";
  };
