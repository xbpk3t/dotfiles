    ...
    services.colima = {
      ...
      profiles.default = {
        ...
        settings = {
          ...
          # value can only be increased after virtual machine has been created.
          #
          # Default: 100
          disk = 100;
          ...
          #
          # value cannot be changed after virtual machine is created.
          # Default: host
          #
          ...
          # some settings may affect Colima's ability to start docker. e.g. `hosts`.
          #
