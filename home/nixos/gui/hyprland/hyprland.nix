  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      exec-once = [
        ...
        # DMS配置 - 剪贴板历史 (clip-history integration)
        "bash -c \"wl-paste --watch cliphist store &\""

        # DMS配置 - 权限提升提示 (elevation prompts)
        "/usr/lib/mate-polkit/polkit-mate-authentication-agent-1"

        # DMS配置 - 启动DankShell (start DankShell)
        "dms run"
      ];
      ...
      bind = [
        ...
        # === DMS配置 - 应用和系统控制 ===
        # DMS spotlight搜索 (替换被注释的launcher功能)
      ...
      env = [
        # https://www.reddit.com/r/hyprland/comments/1etyg4n/i_just_updated_hyprland_and_after_a_reboot_my/
        # 把hyprland cursor样式reset回默认
