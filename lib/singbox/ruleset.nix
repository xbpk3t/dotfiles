...
let
  ruleSetUrls =
    if ruleSetSource == "fallback" then
      {
        geoip =
          name: "https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@sing/geo/geoip/${name}.srs";
        geosite =
          name: "https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@sing/geo/geosite/${name}.srs";
      }
    else
      {
        geoip = name: "https://raw.githubusercontent.com/SagerNet/sing-geoip/rule-set/geoip-${name}.srs";
        geosite =
          name: "https://raw.githubusercontent.com/SagerNet/sing-geosite/rule-set/geosite-${name}.srs";
      };
